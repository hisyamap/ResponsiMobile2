...
@Component({
  selector: 'app-datamobil',
  templateUrl: './datamobil.page.html',
  styleUrls: ['./datamobil.page.scss'],
})
export class DatamobilPage {
  page = 0;
  perPage = 10;
  datamobil: any[] = [];
  lists: any[] = [];
    ...
    this.alertController.create({
      ...
      buttons: [
        ...
        },
        {
          ...
          handler: (data: any) => {
            //jika tekan yakin
            this._apiService.hapus(id, '/hapusDatamobil.php?id=').subscribe({
              next: (res: any) => {
                console.log('sukses', res);
                this.page = 0;
                this.perPage = 10;
